class MUSearchBoxv12 {
  ...
  updateSearchListing (value) {
    ...
    document.definitions
      ...
      .map(report => {
        ...
        this.addAndHighlightColumn(row, report.type)
  ...
  init () {
    const v12MuSearchBox = document.querySelector('#v12-mu-search-box')

    if (v12MuSearchBox) {
      v12MuSearchBox.addEventListener('keyup', e => {
